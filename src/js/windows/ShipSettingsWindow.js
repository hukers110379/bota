class ShipSettingsWindow{
    createWindow() {
        ...
        },
        {
            ...
            attrs:{
                class: "camo",
                value : window.settings.settings.camouflageSlot
            },
            event: function () {
        ...
        },
        {
            ...
            attrs:{
                ...
                max: 100,
                step: 1,
                value : window.settings.settings.reviveLimit
            },
            event: function () {
        ...
        },
        {
            ...
            attrs:{
                ...
                max: 100,
                step: 1,
                value : window.settings.settings.petReviveLimit
            },
            event: function () {
                window.settings.settings.petReviveLimit = this.value;
                if(this.value == -1){
                    $('span:last-child', this.label).text('(∞)');
                }else{
                    $('span:last-child', this.label).text(' (' + this.value + ')');
                }
            }
